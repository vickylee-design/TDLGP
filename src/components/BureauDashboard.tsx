...
const BureauDashboard: React.FC = () => {
  ...
  const webFilterData = [
    { name: '賭博網站', value: Math.floor(Math.random() * 50) },
    { name: '色情內容', value: Math.floor(Math.random() * 30) },
    { name: '惡意軟體', value: Math.floor(Math.random() * 20) },
    { name: '遊戲私服', value: Math.floor(Math.random() * 40) },
    { name: '詐騙釣魚', value: Math.floor(Math.random() * 15) },
  ];
